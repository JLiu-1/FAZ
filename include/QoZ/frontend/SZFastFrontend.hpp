...
//                    const QoZMETA::meta_params &params, SZMETA::CompressStats &compress_info) {
        std::vector<int> compress_3d(const T *data) {
            ...
            //std::cout<<"yuanshen qidong"<<std::endl;
...
//        T precision_t = (T) precision;
           ...
           // std::cout<<"yuanshen qidong1"<<std::endl;
           ...
           // std::cout<<"yuanshen qidong2"<<std::endl;
...
//
           ...
           // std::cout<<"yuanshen qidong3"<<std::endl;
            free(pred_buffer);
            free(reg_params);
            if (reg_count) {
            ...
            indicator_huffman.preprocess_encode(indicator, SELECTOR_RADIUS);
            //std::cout<<"yuanshen qidong4"<<std::endl;
